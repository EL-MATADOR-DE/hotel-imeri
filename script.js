...
const translations = {
  ka: {
    ...
    footer_rights: "© 2026 პარკ ჰოტელი იმერი . ყველა უფლება დაცულია.",
    btn_more: "მეტი",
  ...
  en: {
    ...
    footer_rights: "© 2026 Park Hotel Imeri . All rights reserved.",
    btn_more: "More",
  ...
  ru: {
    ...
    footer_rights: "© 2026 Парк Отель Имери . Все права защищены.",
    btn_more: "Больше",
  ...
  de: {
    ...
    footer_rights: "© 2026 Park Hotel Imeri . Alle Rechte vorbehalten.",
    btn_more: "Mehr",
